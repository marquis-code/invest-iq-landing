      ...
      >
        ...
        <div class="absolute w-full h-full backface-hidden bg-white rounded-lg shadow-lg overflow-hidden rotate-y-180">
          <div class="pt-6">
            ...
            <p class="text-gray-500 text-sm mb-4 px-6">{{ project.location }}</p>
            <p class="text-gray-700 mb-6 px-6">{{ project.description }}</p>
            
            <div class="relative pt-4 mb-6 px-6">
              <div class="h-1 bg-gray-200 rounded-full">
                <div 
                  class="h-1 bg-emerald-500 rounded-full"
                  :style="`width: ${(project.raised / project.goal) * 100}%`"
         ...
         <div class="pt-14">
          <button class="w-full  bg-pink-400 text-white py-3  hover:bg-pink-500 transition-colors uppercase">
              View
            </button>
         </div>
          </div>

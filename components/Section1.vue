  ...
  <div class="relative isolate overflow-hidden bg-gradient-to-b from-indigo-100/20 pt-14">
    ...
    <div class="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
        <h1 class="max-w-2xl text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl lg:col-span-2 xl:col-auto">Grow your portfolio with compound interests!
        </h1>
        <div class="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
          <p class="text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">The Maximum Yield Note offers you an opportunity to invest a lump sum amount and grow it over a period, earning good returns through compound interests in the process. It typically provides a significantly higher rate of return compared to the average yield of similar low-risk instruments in the fixed-income market.
        </p>
          <div class="mt-10 flex items-center gap-x-6">
            <a href="#" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
            <!-- <a href="#" class="text-sm/6 font-semibold text-gray-900">Get Started <span aria-hidden="true">→</span></a> -->
          </div>
        </div>
